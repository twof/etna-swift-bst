...
/// active in the compiled `BST` module.
public func solve(
    property: String,
    duration: Duration,
    ...
    case "UnionValid":
        return await runFuzz(ArgTT.self, duration: duration, coverageStrategy: coverageStrategy,
    ...
    case "UnionPost":
        return await runFuzz(ArgTTI.self, duration: duration, coverageStrategy: coverageStrategy,
    ...
    case "InsertUnion":
        return await runFuzz(ArgTTII.self, duration: duration, coverageStrategy: coverageStrategy,
    ...
    case "UnionUnionIdem", "UnionUnionIdempotent":
        return await runFuzz(ArgT.self, duration: duration, coverageStrategy: coverageStrategy,
                             wire: { $0.wire }, check: { prop_union_union_idempotent($0.t) })
    case "UnionUnionAssoc":
        return await runFuzz(ArgTTT.self, duration: duration, coverageStrategy: coverageStrategy,
